...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center max-w-[1240px] mx-auto px-4 text-black border-b border-neutral-200 h-[80px]">
      {/* Logo */}
      ...
      >
        <h1 className="w-full text-3xl font-bold text-[#00df9a] m-4" id="heading">
        <span className="text-[#d4a373] " id="Beskar">
            Beskar
          </span>
